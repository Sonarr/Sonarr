...
namespace NzbDrone.Core.Backup
{
    ...
    public class BackupService : IBackupService, IExecute<BackupCommand>
    {
        ...
        public void Backup(BackupType backupType)
        {
            ...
            var backupFilename = String.Format("nzbdrone_backup_{0:yyyyMMddHHmmss}.zip", DateTime.Now);
        ...
        public List<Backup> GetBackups()
        {
            ...
            foreach (var backupType in Enum.GetValues(typeof(BackupType)).Cast<BackupType>())
            {
                ...
                {
                    backups.AddRange(_diskProvider.GetFiles(folder, SearchOption.TopDirectoryOnly)
                                                  .Select(b => new Backup
                                                               {
        ...
        private void CleanupOldBackups(BackupType backupType)
        {
            ...
            var files = _diskProvider.GetFiles(GetBackupFolder(backupType), SearchOption.TopDirectoryOnly);
