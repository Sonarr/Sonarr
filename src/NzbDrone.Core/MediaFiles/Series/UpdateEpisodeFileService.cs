...
namespace NzbDrone.Core.MediaFiles.Series
{
    ...
    {
        void ChangeFileDateForFile(EpisodeFile episodeFile, Tv.Series series, List<Episode> episodes);
    }
                                            ...
                                            IHandle<SeriesScannedEvent>
    {
        ...
        public void ChangeFileDateForFile(EpisodeFile episodeFile, Tv.Series series, List<Episode> episodes)
        {
            ChangeFileDate(episodeFile, series, episodes);
        }

        private bool ChangeFileDate(EpisodeFile episodeFile, Tv.Series series, List<Episode> episodes)
        {
