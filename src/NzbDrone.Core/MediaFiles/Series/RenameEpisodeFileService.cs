...
namespace NzbDrone.Core.MediaFiles.Series
{
                                            ...
                                            IExecute<RenameSeriesCommand>
    {
        ...
        private IEnumerable<RenameEpisodeFilePreview> GetPreviews(Tv.Series series, List<Episode> episodes, List<EpisodeFile> files)
        {
        ...
        private void RenameFiles(List<EpisodeFile> episodeFiles, Tv.Series series)
        {
            ...
            foreach (var episodeFile in episodeFiles)
            {
                ...
                try
                {
                    ...
                    _fileMover.MoveFile(episodeFile, series);
        ...
        public void Execute(RenameFilesCommand message)
        {
            ...
            var episodeFiles = _mediaFileService.GetEpisodeFiles(message.Files);
        ...
        void IExecute<RenameFilesCommand>.Execute(RenameFilesCommand message)
        {
