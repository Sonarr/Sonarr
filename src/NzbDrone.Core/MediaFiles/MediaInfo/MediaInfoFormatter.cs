...
namespace NzbDrone.Core.MediaFiles.MediaInfo
{
    public static class MediaInfoFormatter
    {
        ...
        private static decimal? FormatAudioChannelsFromAudioChannelPositions(MediaInfoModel mediaInfo)
        {
            ...
            {
                Logger.Warn(e, "Unable to format audio channels using 'AudioChannelPositions', with a value of: '{0}' and '{1}'", audioChannelPositions, mediaInfo.AudioChannelPositionsTextContainer);
            }
