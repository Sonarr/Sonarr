...
{
    public class DailyEpisodeMatchSpecification : BaseSeriesSpecification
    {
        ...
        public override Decision IsSatisfiedBy(RemoteEpisode remoteEpisode, SeriesSearchCriteriaBase searchCriteria)
        {
            ...
            var episode = _episodeService.GetEpisode(dailySearchSpec.Media.Id, dailySearchSpec.AirDate.ToString(Episode.AIR_DATE_FORMAT));
