...
namespace NzbDrone.Core.DecisionEngine.Specifications.RssSync.Common
{
    public class ProperSpecification : IDecisionEngineSpecification
    {
        ...
        public virtual Decision IsSatisfiedBy(RemoteItem subject, SearchCriteriaBase searchCriteria)
        {
            ...
            {
                if (_qualityUpgradableSpecification.IsRevisionUpgrade(file.Quality, subject.ParsedInfo.Quality))
                {
