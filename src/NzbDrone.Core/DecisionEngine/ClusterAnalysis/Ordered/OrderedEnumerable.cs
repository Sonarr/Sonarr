...
{
    public sealed class OrderedEnumerable<TElement, TKey> : OrderedClusteredEnumerableBase<TElement>
    {
        private readonly Func<ClusteredElement<TElement>, TKey> _keySelector;
        private readonly IComparer<TKey> _comparer;
        private readonly bool _descending;

        public OrderedEnumerable(IEnumerable<TElement> source, OrderedClusteredEnumerableBase<TElement> parent,
        ...
        {
            return Parent == null ? source : Parent.ApplyClustering(source);
        }
    }
}