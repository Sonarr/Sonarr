        ...
        public virtual IList<ImportListItemInfo> ParseResponse(ImportListResponse importResponse)
        {
            ...
            if (jsonResponse.Anime != null)
            {
                foreach (var show in jsonResponse.Anime)
                {
                    ...
                    if (tentativeTvdbId > 0 && (show.AnimeType == SimklAnimeType.Tv || show.AnimeType == SimklAnimeType.Ona || show.AnimeType == SimklAnimeType.Ova || show.AnimeType == SimklAnimeType.Special))
                    {
