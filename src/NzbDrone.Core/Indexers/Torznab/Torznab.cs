    ...
    public class Torznab : HttpIndexerBase<TorznabSettings>
    {
        ...
        public override IEnumerable<ProviderDefinition> DefaultDefinitions
        {
            get
            {
                ...
                yield return GetDefinition("Jackett", GetSettings("http://localhost:9117/torznab/YOURINDEXER", categories: new int[] { 5000, 5020, 5030, 5040, 5045, 5050, 5080 }, animeCategories: new[0]));
            }
        }
