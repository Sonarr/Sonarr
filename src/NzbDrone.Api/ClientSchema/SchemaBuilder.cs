...
namespace NzbDrone.Api.ClientSchema
{
    public static class SchemaBuilder
    {
        ...
        private static FieldMapping[] GetFieldMapping(Type type, Func<object, object> targetSelector)
        {
            ...
            foreach (var property in GetProperties(type))
            {
                ...
                {
                    result.AddRange(GetFieldMapping(propertyInfo.PropertyType, t => propertyInfo.GetValue(targetSelector(t), null)));
                }
            }
