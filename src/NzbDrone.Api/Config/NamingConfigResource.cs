...
namespace NzbDrone.Api.Config
{
    public class NamingConfigResource : RestResource
    {
        ...
        public string SpecialsSeasonFolderFormat { get; set; }
    ...
    public static class NamingConfigResourceMapper
    {
        public static NamingConfigResource ToResource(this NamingConfig model)
        {
            return new NamingConfigResource
            {
                ...
                SpecialsSeasonFolderFormat = model.SpecialsSeasonFolderFormat
                //IncludeSeriesTitle
                //IncludeEpisodeTitle
                //IncludeQuality
                //ReplaceSpaces
        ...
        public static NamingConfig ToModel(this NamingConfigResource resource)
        {
            return new NamingConfig
            {
                ...
                SpecialsSeasonFolderFormat = resource.SpecialsSeasonFolderFormat
            };
        }
    }
}