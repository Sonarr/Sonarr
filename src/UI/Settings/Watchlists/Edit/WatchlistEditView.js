...
var DeleteView = require('../Delete/WatchlistDeleteView');
...
var view = Marionette.ItemView.extend({
    template : 'Settings/Watchlists/Edit/WatchlistEditViewTemplate',
    ...
    _onAfterSaveAndAdd : function() {
        ...
        require('../Add/WatchlistSchemaModal').open(this.targetCollection);
    },
