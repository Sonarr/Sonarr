...
namespace Workarr.Messaging.Commands
{
    ...
    public class CommandQueueManager : IManageCommandQueue, IHandle<ApplicationStartedEvent>
    {
        ...
        public void Cancel(int id)
        {
            ...
            {
                throw new WorkarrClientException(HttpStatusCode.Conflict, "Unable to cancel task");
            }
        }
        ...
        private Command GetCommand(string commandName)
        {
            ...
            var commandType = Enumerable.Single<Type>(commands, c => c.Name.Equals(commandName, StringComparison.InvariantCultureIgnoreCase));
