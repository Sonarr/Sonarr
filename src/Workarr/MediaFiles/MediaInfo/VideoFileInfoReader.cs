...
namespace Workarr.MediaFiles.MediaInfo
{
    ...
    public class VideoFileInfoReader : IVideoFileInfoReader
    {
        ...
        public MediaInfoModel GetMediaInfo(string filename)
        {
            ...
            try
            {
                ...
                mediaInfoModel.AudioLanguages = Enumerable
                    .Where<string>(analysis.AudioStreams?.Select(x => x.Language), l => StringExtensions.IsNotNullOrWhiteSpace(l))
                    .ToList();
                mediaInfoModel.Subtitles = Enumerable
                    .Where<string>(analysis.SubtitleStreams?.Select(x => x.Language), l => StringExtensions.IsNotNullOrWhiteSpace(l))
                    .ToList();
