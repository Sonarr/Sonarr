...
{
    public static class WorkarrLogger
    {
        ...
        private static void RegisterSentry(bool updateClient, IAppFolderInfo appFolderInfo)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogManager.GetLogger(nameof(WorkarrLogger)).Debug(ex, "Failed to load dependency, may need an OS update");
