...
namespace Workarr.EnvironmentInfo
{
    ...
    public class AppFolderFactory : IAppFolderFactory
    {
        ...
        public void Register()
        {
            ...
            {
                throw new WorkarrStartupException("Cannot create AppFolder, Access to the path {0} is denied", _appFolderInfo.AppDataFolder);
            }
            ...
            {
                throw new WorkarrStartupException("AppFolder {0} is not writable", _appFolderInfo.AppDataFolder);
            }
        ...
        private void MigrateAppDataFolder()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new WorkarrStartupException("Unable to migrate AppData folder from {0} to {1}. Migrate manually", _appFolderInfo.LegacyAppDataFolder, _appFolderInfo.AppDataFolder);
            }
        }
