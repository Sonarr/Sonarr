...
{
    [TestFixture]
    public class DeleteEpisodeFileFixture : CoreTest<Workarr.MediaFiles.MediaFileDeletionService>
    {
        ...
        {
            Assert.Throws<WorkarrClientException>(() => Subject.DeleteEpisodeFile(_series, _episodeFile));
