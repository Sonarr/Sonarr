...
namespace NzbDrone.Core.Test.ParserTests.ParsingServiceTests
{
    ...
    public class GetEpisodesFixture : TestBase<ParsingService>
    {
        ...
        public void should_use_tvdb_season_number_when_available_and_a_scene_source()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Verify(v => v.FindEpisode(_series.Id, _parsedEpisodeInfo.SeasonNumbers.FirstOrDefault(), _parsedEpisodeInfo.EpisodeNumbers.First()), Times.Never());
        ...
        public void should_not_use_tvdb_season_number_when_available_for_a_different_season_and_a_scene_source()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Verify(v => v.FindEpisode(_series.Id, _parsedEpisodeInfo.SeasonNumbers.FirstOrDefault(), _parsedEpisodeInfo.EpisodeNumbers.First()), Times.Once());
        }
        ...
        public void should_lookup_full_season_by_season_number_if_series_does_not_use_scene_numbering()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Setup(s => s.GetEpisodesBySeason(_series.Id, _parsedEpisodeInfo.SeasonNumbers.FirstOrDefault()))
                .Returns(_episodes);
        ...
        public void should_lookup_full_season_by_scene_season_number_if_series_uses_scene_numbering()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                .Setup(s => s.GetEpisodesBySceneSeason(_series.Id, _parsedEpisodeInfo.SeasonNumbers.FirstOrDefault()))
                .Returns(_episodes);
        ...
        public void should_use_original_parse_result_when_special_episode_lookup_by_title_fails()
        {
            ...
            Mocker.GetMock<IEpisodeService>()
                  .Verify(v => v.FindEpisode(_series.TvdbId, _parsedEpisodeInfo.SeasonNumbers.FirstOrDefault(), _parsedEpisodeInfo.EpisodeNumbers.First()), Times.Once());
        }
    }
}
