...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class UrlFixture : CoreTest
    {
        ...
        [TestCase("[test-hyphen123.co.za] - The Daily Series -", "The Daily Series")]
        [TestCase("www.test123.co.za - The Series Bros. (2006)", "The Series Bros.")]
        [TestCase("[www.test-hyphen.ca] - Series (2011)", "Series")]
        [TestCase("test123.ca - Series Time S02 720p HDTV x264 CRON", "Series Time")]
        [TestCase("[www.test-hyphen123.co.za] - Series Title 0", "Series Title 0")]
