...
namespace NzbDrone.Core.Test.Datastore
{
    ...
    public class DatabaseRelationshipFixture : DbTest
    {
        ...
        public async Task one_to_one()
        {
            ...
            var loadedEpisode = await Db.SingleAsync<Episode>();
            var loadedEpisodeFile = loadedEpisode.EpisodeFile.Value;
        ...
        public async Task one_to_one_should_not_query_db_if_foreign_key_is_zero()
        {
            ...
            var loadedEpisode = await Db.SingleAsync<Episode>();
            loadedEpisode.EpisodeFile.Value.Should().BeNull();
        }
        ...
        public async Task embedded_document_as_json()
        {
            ...
            var episodeHistory = await Db.SingleAsync<EpisodeHistory>();
            var loadedQuality = episodeHistory.Quality;
