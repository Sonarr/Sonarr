...
namespace NzbDrone.Core.Test.Datastore.Migration
{
    ...
    public class mediainfo_channel_propertiesFixture : MigrationTest<mediainfo_channels>
    {
        ...
        public void should_change_property_names_for_audio_channels()
        {
            ...
            var items = db.Query<EpisodeFile133>("SELECT MediaInfo FROM EpisodeFiles");
        ...
        public class EpisodeFile133
        {
            public int Id { get; set; }
            public MediaInfo133 MediaInfo { get; set; }
        }

        public class MediaInfo133
        {
