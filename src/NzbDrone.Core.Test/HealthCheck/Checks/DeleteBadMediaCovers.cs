    ...
    public class DeleteBadMediaCoversFixture : CoreTest<DeleteBadMediaCovers>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IMetadataFileService>()
                .Setup(c => c.GetFilesBySeries(_series[0].Id))
                .Returns(_metaData);
        ...
        {
            _metaData[0].LastUpdated = new DateTime(2014, 12, 25);
        ...
        public void should_delete_html_images()
        {
            ...
            Mocker.GetMock<IMetadataFileService>().Verify(c => c.Delete(_metaData[0].Id), Times.Once());
        }
