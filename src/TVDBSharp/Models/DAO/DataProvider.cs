...
namespace TVDBSharp.Models.DAO
{
    ...
    public class DataProvider : IDataProvider
    {
        ...
        public XDocument GetShow(int showID, string lang)
        {
            return GetXDocumentFromUrl(string.Format("{0}/api/{1}/series/{2}/all/{3}.xml", BaseUrl, ApiKey, showID, lang));
        }
        ...
        public XDocument Search(string query, string lang)
        {
            return GetXDocumentFromUrl(string.Format("{0}/api/GetSeries.php?seriesname={1}&language={2}", BaseUrl, query, lang));
        }
