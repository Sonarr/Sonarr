    ...
    public class SingleInstancePolicy : ISingleInstancePolicy
    {
        ...
        private List<int> GetOtherNzbDroneProcessIds()
        {
            try
            {
                ...
                var otherProcesses = _processProvider.FindProcessByName(ProcessProviderBase.NZB_DRONE_CONSOLE_PROCESS_NAME)
                                                     .Union(_processProvider.FindProcessByName(ProcessProviderBase.NZB_DRONE_PROCESS_NAME))
                                                     .Select(c => c.Id)
